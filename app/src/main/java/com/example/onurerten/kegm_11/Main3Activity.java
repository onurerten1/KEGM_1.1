...
public class Main3Activity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTextView = (TextView)findViewById(R.id.sonuc2);
        mButton = (Button)findViewById(R.id.hesap2);
    ...
    public void calculate(){
        ...
        if (value<=1000.0) {
            Double calculatedValue=100.0;
            mTextView.setText(calculatedValue.toString());
        }
        else if(value>1000.0) {
            Double calculatedValue= (value-1000.0)*(40.0/1000.0) + 100.0;
            mTextView.setText(calculatedValue.toString());
        }
    }
